...
updated: 2026-02-21T21:33:31-08:00
draft: false
comments: false
...
{{< note >}}
UPDATE Aug 10 2021:
An article <a id="cite-mnras-flaring"></a>[[mnras-flaring]](#ref-mnras-flaring) in the _Monthly Notices of the Royal Astronomical Society_ suggests that ultra-cool dwarf stars are potentially not as deadly as first thought <a id="cite-skyandtelescope-red-dwarfs"></a>[[skyandtelescope-red-dwarfs]](#ref-skyandtelescope-red-dwarfs). The article suggests that the flaring tends to happen at higher latitudes on the star, which would result in such flares to tend to be directed away from the planets which are located closer to the equatorial plane of the star. Should this prove to be accurate, then that would soften the skepticism we displayed in the earlier version of this blog in regards to stars of this type hosting life, although the other causes of skepticism still remain high.
{{< /note >}}
...
An article published in the science journal _Nature_ <a id="cite-nature-discovery"></a>[[nature-discovery]](#ref-nature-discovery)
...
star. __CNN__ was pretty tame by announcing <a id="cite-cnn-announcement"></a>[[cnn-announcement]](#ref-cnn-announcement) that _Astronomers discover 7 Earth-sized planets orbiting nearby star_ in their headline. The __New York Times__ was
equally tame in announcing <a id="cite-nytimes-announcement"></a>[[nytimes-announcement]](#ref-nytimes-announcement) that _7 Earth-Size Planets Orbit Dwarf Star, NASA and European Astronomers Say_. __NBC__ went a little
louder with the headline <a id="cite-nbc-announcement"></a>[[nbc-announcement]](#ref-nbc-announcement)
...
__CNET__ was bolder <a id="cite-cnet-announcement"></a>[[cnet-announcement]](#ref-cnet-announcement)
...
The UK __Telegraph__ pushed it <a id="cite-telegraph-announcement"></a>[[telegraph-announcement]](#ref-telegraph-announcement) a bit
further with the headline _Nasa discovers new solar system TRAPPIST-1 - where life may have evolved on three planets_.
The __Guardian__ asked <a id="cite-guardian-announcement"></a>[[guardian-announcement]](#ref-guardian-announcement)
...
a bit fond of that creative website <a id="cite-io9-fanfic"></a>[[io9-fanfic]](#ref-io9-fanfic)
...
TRAPPIST-1 <a id="cite-wiki-trappist1"></a>[[wiki-trappist1]](#ref-wiki-trappist1) is a very small and relatively cold
...
life.
* Ultracool stars, which TRAPPIST-1 is classified as, are the most common type <a id="cite-trappist1-website"></a>[[trappist1-website]](#ref-trappist1-website) of
...
in massive global winds if the planets retain their atmospheres. There is still a lot of debate <a id="cite-habitable-zone-debate"></a>[[hz-debate]](#ref-hz-debate)
...
* **Inner Planets (b, c, d):** Observations strongly suggest that TRAPPIST-1 b, c, and d do not possess thick, Earth-like atmospheres. In a pair of pivotal _Nature_ publications, authors Greene et al. (2023) <a id="cite-greene-nature"></a>[[greene-nature]](#ref-greene-nature) and Zieba et al. (2023) <a id="cite-zieba-nature"></a>[[zieba-nature]](#ref-zieba-nature) utilized JWST's Mid-Infrared Instrument (MIRI) to measure the thermal emissions of planets b and c, finding them consistent with bare rocky bodies or possessing, at most, extremely thin atmospheres. Planet d's spectrum is similarly flat, pointing to a barren world despite residing near the inner edge of the habitable zone.

![TRAPPIST-1 b Secondary Eclipse Light Curve (JWST MIRI)](assets/trappist1b_jwst.jpg)
...
Even if the entire world turned all of their defense spending towards producing a Generation ship <a id="cite-wiki-generation-ship"></a>[[wiki-generation-ship]](#ref-wiki-generation-ship) to reach TRAPPIST-1 and impoverished the planet's resources to supply fuel and food supplies for said ship, we are still talking many tens of thousands of years at best, ignoring all threats to human life such as radiation, collision with stray objects, etc. One could easily imagine that within a few generations, the community on the generational
...
the Wait Calculation <a id="cite-wait-calculation"></a>[[wait-calculation]](#ref-wait-calculation) (A. Kennedy, _Interstellar Travel: The Wait Calculation and the Incentive Trap of Progress_, JBIS __59__, July 2006) which is relevant beyond the concept of a generation ship.
...
- **[nature-discovery]** **<a id="ref-nature-discovery"></a>Gillon, M., Triaud, A.H.M.J., Demory, B.-O., et al. (2017).** *[Seven temperate terrestrial planets around the nearby ultracool dwarf star TRAPPIST-1](http://nature.com/articles/doi:10.1038/nature21360).* Nature. [↩](#cite-nature-discovery)
- **[mnras-flaring]** **<a id="ref-mnras-flaring"></a>Ilin, E., et al. (2021).** *[Giant white-light flares on fully convective stars occur at high latitudes](https://academic.oup.com/mnras/article-abstract/507/2/1723/6339287?redirectedFrom=fulltext&login=false).* Monthly Notices of the Royal Astronomical Society. ([Preprint](https://arxiv.org/abs/2108.01917)). [↩](#cite-mnras-flaring)
- **[greene-nature]** **<a id="ref-greene-nature"></a>Greene, T.P., Bell, T.J., Ducrot, E. et al. (2023).** *[Thermal Emission from the Earth-sized Exoplanet TRAPPIST-1 b using JWST](https://www.nature.com/articles/s41586-023-05951-7).* Nature. [↩](#cite-greene-nature)
- **[zieba-nature]** **<a id="ref-zieba-nature"></a>Zieba, S., Kreidberg, L., Ducrot, E. et al. (2023).** *[No thick carbon dioxide atmosphere on the rocky exoplanet TRAPPIST-1 c](https://www.nature.com/articles/s41586-023-06232-z).* Nature. [↩](#cite-zieba-nature)
- **[cnn-announcement]** **<a id="ref-cnn-announcement"></a>CNN. (2017).** *[Astronomers discover 7 Earth-sized planets orbiting nearby star](http://www.cnn.com/2017/02/22/world/new-exoplanets-discovery-nasa/).* [↩](#cite-cnn-announcement)
- **[nytimes-announcement]** **<a id="ref-nytimes-announcement"></a>New York Times. (2017).** *[7 Earth-Size Planets Orbit Dwarf Star, NASA and European Astronomers Say](https://www.nytimes.com/2017/02/22/science/trappist-1-exoplanets-nasa.html?_r=0).* [↩](#cite-nytimes-announcement)
- **[nbc-announcement]** **<a id="ref-nbc-announcement"></a>NBC. (2017).** *[Living on the TRAPPIST-1 Planets Would Be Very Strange](http://www.nbcnews.com/mach/space/living-trappist-1-planets-would-be-very-strange-n725206).* [↩](#cite-nbc-announcement)
- **[cnet-announcement]** **<a id="ref-cnet-announcement"></a>CNET. (2017).** *['Incredible' star system could host life](https://www.cnet.com/pictures/trappist-1-star-system-could-host-life-exoplanets-earth-like/).* [↩](#cite-cnet-announcement)
- **[telegraph-announcement]** **<a id="ref-telegraph-announcement"></a>Telegraph. (2017).** *[Nasa discovers new solar system TRAPPIST-1 - where life may have evolved on three planets](http://www.telegraph.co.uk/science/2017/02/22/nasa-announcement-live/).* [↩](#cite-telegraph-announcement)
- **[guardian-announcement]** **<a id="ref-guardian-announcement"></a>The Guardian. (2017).** *[is there life on exoplanets orbiting Trappist-1?](https://www.theguardian.com/science/2017/feb/24/lab-notes-is-there-life-on-exoplanets-orbiting-trappist-1).* [↩](#cite-guardian-announcement)
- **[io9-fanfic]** **<a id="ref-io9-fanfic"></a>io9 / Gizmodo. (2017).** *[NASA Is Turning TRAPPIST-1 Into Science Nerd Fanfic](http://io9.gizmodo.com/nasa-is-turning-trappist-1-into-science-nerd-fanfic-1792713502).* [↩](#cite-io9-fanfic)
- **[skyandtelescope-red-dwarfs]** **<a id="ref-skyandtelescope-red-dwarfs"></a>Sky & Telescope.** *[Red Dwarfs Aren't So Bad for Planets After All](https://skyandtelescope.org/astronomy-news/red-dwarfs-arent-so-bad-for-planets-after-all/).* [↩](#cite-skyandtelescope-red-dwarfs)
- **[wiki-trappist1]** **<a id="ref-wiki-trappist1"></a>Wikipedia.** *[TRAPPIST-1](https://en.wikipedia.org/wiki/TRAPPIST-1).* [↩](#cite-wiki-trappist1)
- **[trappist1-website]** **<a id="ref-trappist1-website"></a>TRAPPIST-1 Website.** *[About TRAPPIST-1](http://www.trappist.one/#about).* [↩](#cite-trappist1-website)
- **[hz-debate]** **<a id="ref-hz-debate"></a>Kopparapu, R.K., et al. (2016).** *[The Habitable Zone for Earth-like planets](https://arxiv.org/abs/1602.05176).* arXiv preprint. [↩](#cite-hz-debate)
- **[hydrogen-burn-rate]** **<a id="ref-hydrogen-burn-rate"></a>Laughlin, G., Bodenheimer, P., & Adams, F. C. (1997).** *[The end of the main sequence](http://onlinelibrary.wiley.com/doi/10.1002/asna.200510440/abstract).* Astronomische Nachrichten. [↩](#cite-hydrogen-burn-rate)
- **[wiki-generation-ship]** **<a id="ref-wiki-generation-ship"></a>Wikipedia.** *[Generation ship](https://en.wikipedia.org/wiki/Generation_ship).* [↩](#cite-wiki-generation-ship)
- **[krulwich-extinction]** **<a id="ref-krulwich-extinction"></a>Krulwich, R. (2012).** *[How Human Beings Almost Vanished From Earth In 70,000 B.C.](http://www.npr.org/sections/krulwich/2012/10/22/163397584/how-human-beings-almost-vanished-from-earth-in-70-000-b-c).* NPR. [↩](#cite-krulwich-extinction)
- **[wait-calculation]** **<a id="ref-wait-calculation"></a>Kennedy, A. (2006).** *[Interstellar Travel: The Wait Calculation and the Incentive Trap of Progress](https://ui.adsabs.harvard.edu/abs/2006JBIS...59..239K/abstract).* Journal of the British Interplanetary Society (JBIS). [↩](#cite-wait-calculation)
- **[burgasser-age]** **<a id="ref-burgasser-age"></a>Burgasser, A. J., & Mamajek, E. E. (2017).** *[On the Age of the TRAPPIST-1 System](https://iopscience.iop.org/article/10.3847/1538-4357/aa7fea).* The Astrophysical Journal. [↩](#cite-burgasser-age)
